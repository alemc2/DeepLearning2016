...
\ifnum\me<2
\begin{solution}
\\We performed experiments on the MNIST dataset trying to classify on it using a 4 layered network. We achieved an accuracy of $99.4\%$ on the test set with our model. A detailed explanation of our experiments is mentioned below:
\begin{enumerate}
